...
class OpenLigaDBStdlibTransport:
    """HTTPS transport that bounds the public provider response body."""
    ...
    def get(
        ...
        if parsed.scheme != "https" or not parsed.hostname:
            raise ValueError("OpenLigaDB transport requires an HTTPS URL.")
