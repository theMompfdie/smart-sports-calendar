...
| UEFA EURO 2028 qualification | 2026–28 | Deferred | Evidence retained in #176 and #177; fixture recheck follows the 6 December 2026 draw | Unassigned; runtime and release inclusion disabled | Excluded from `v0.6.0-beta.1`; separately approved December release only | [Deferred delivery track #176](https://github.com/theMompfdie/smart-sports-calendar/issues/176) |
